...
export const statesByCountry: Record<string,{ label: string; code: string }[]> = {
  IN: [
  ...
  AE: [
    ...
    { label: "Abu Dhabi", code: "AUH" },
    { label: "Sharjah", code: "SHJ" },
  ],

  PK: [
    { label: "Punjab", code: "PB" },
    { label: "Sindh", code: "SD" },
    { label: "Khyber Pakhtunkhwa", code: "KP" },
    { label: "Balochistan", code: "BA" },
  ],
  ...
  GB: [
    ...
    { label: "Scotland", code: "SCT" },
    { label: "Wales", code: "WLS" },
    { label: "Northern Ireland", code: "NIR" },
  ],
};