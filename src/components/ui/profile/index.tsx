...
import { Box, Typography, Menu, MenuItem, Avatar, ListItemIcon, ListItemText, Divider, ListItemButton } from "@mui/material";
...
export default function ProfileMenu() {
  ...
  return (
    <Box onMouseEnter={handleOpen} onMouseLeave={handleClose}
      ...
      <Typography variant="body2" sx={{ color: theme.palette.background.TableRowColor, fontSize: 15, fontWeight: 500, }}>John Doe</Typography>
      ...
      <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={() => setAnchorEl(null)}
        ...
        slotProps={{
          ...
          <ListItemButton onClick={() => navigate("/app/myaccount")}  sx={{ py: 0.8, px: 2, mx: 0.75, borderRadius: 2, }} >
            <ListItemIcon>
        ...
        <Divider sx={{ my: 1 }} />
          ...
          <ListItemButton onClick={() => navigate("/signin")} sx={{
