...
const Sidebar = ({ open, toggleSidebar, isMobile }: any) => {
    ...
    return (
        <Drawer variant={isMobile ? "temporary" : "permanent"} open={open} onClose={toggleSidebar} sx={{
             backgroundColor: theme.palette.background.default,
            "& .MuiDrawer-paper": { width: open ? 276 : 90, transition: "width 0.2s", backgroundColor: theme.palette.background.default, borderRight: "none", },
        }}>
            <Box sx={{
