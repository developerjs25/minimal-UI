...
import { getUserStatusStyle } from "../contact/UserContant";
                ...
                <Tab sx={{ "&.Mui-selected": { color: theme.palette.background.whiteBlack }, textTransform: "none", }}
                  label={
                    <Box display="flex" alignItems="center" gap={1}>Banned
                      <StyledChip label={bannedCount.toString()} bgcolor={value === "4" ? "#FF5630" : "rgba(255, 86, 58, 0.16)"} color={value === "4" ? "white.main" : "#FFAC82"} />
                    </Box>
                  }
                  value="4"
                />
                ...
                <Table sx={{ minWidth: 960 }}>
                  <TableHead>
                    <TableRow sx={{ backgroundColor: theme.palette.background.TableRowColor }}>
                      ...
                      <TableCell sx={{ fontWeight: 550, color: "#637381", }}>Name</TableCell>
                      <TableCell sx={{ fontWeight: 550, color: "#637381", }}>Phone number</TableCell>
                      <TableCell sx={{ fontWeight: 550, color: "#637381", }}>Country</TableCell>
                      <TableCell sx={{ fontWeight: 550, color: "#637381", }}>Role</TableCell>
                      <TableCell sx={{ fontWeight: 550, color: "#637381", }}>Status</TableCell>
                          ...
                          <TableRow key={users._id} selected={isItemSelected} hover
                            ...
                            <TableCell>
                              <Box display="flex" alignItems="center" gap={1}>
                                <Box component="img" src={users.image} alt={users.firstName} sx={{ width: 40, height: 40, borderRadius: "50%" }} />
                                <Stack>
                            ...
                            <TableCell>
                              <StyledChip label={users.status} bgcolor={getUserStatusStyle(users.status).backgroundColor} color={getUserStatusStyle(users.status).color} />
                            </TableCell>
                            <TableCell align="right">
